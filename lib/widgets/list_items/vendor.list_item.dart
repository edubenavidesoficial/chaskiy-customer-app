...
class VendorListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ancho adaptativo: en listas verticales toma el ancho disponible;
    // en carruseles horizontales (sin límite) usa un ancho de diseño fijo
    ...
    return AspectRatio(
      ...
      child: Stack(
        ...
        children: [
          ...
          // botón de ruta en mapa (funcionalidad original conservada)
