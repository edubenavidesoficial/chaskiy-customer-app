...
import 'package:chaskiy/models/order_fee.dart';
import 'package:chaskiy/models/order_service.dart';
import 'package:chaskiy/models/order_status.dart';
...
import 'package:chaskiy/models/booking_order.dart';
...
class Order {
  ...
  void merge(Order other) {
    ...
    this.bookingOrder = other.bookingOrder;
  ...
  get isBooking =>
      vendor?.vendorType != null &&
      (vendor?.vendorType.slug.contains("booking") ?? false);
