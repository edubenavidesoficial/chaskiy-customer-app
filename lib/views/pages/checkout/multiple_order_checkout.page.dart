...
import 'package:chaskiy/view_models/multiple_checkout.vm.dart';
...
import 'package:chaskiy/widgets/cards/multiple_vendor_order_summary.dart';
...
class MultipleOrderCheckoutPage extends StatelessWidget {
  const MultipleOrderCheckoutPage({required this.checkout, Key? key})
    : super(key: key);
