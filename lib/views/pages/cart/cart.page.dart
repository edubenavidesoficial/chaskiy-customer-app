                  ...
                  VStack([
                    ...
                    Container(
                      ...
                      child: VStack([
                        ...
                        AmountTile(
                          "Sub-Total".tr(),
                          "${model.currencySymbol} ${model.subTotalPrice.convertCurrency}"
                              .currencyFormat(),
                          amountStyle: summaryStyle,
                        ),
                        Visibility(
                          ...
                          child: AmountTile(
                            "Discount".tr(),
                            "${model.currencySymbol} ${model.discountCartPrice.convertCurrency}"
                                .currencyFormat(),
                            amountStyle: summaryStyle,
                          ),
                        ),
                        ...
                        AmountTile(
                          "Total".tr(),
                          "${model.currencySymbol} ${model.totalCartPrice.convertCurrency}"
                              .currencyFormat(),
